		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"90%","margin":"0 auto 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"display":"block"}' >
					...
					<div :style='{"margin":"0 30px 0 0","display":"inline-block"}'>
						<label :style='{"margin":"0 10px 0 0","color":"#333","textAlign":"center","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"16px","fontWeight":"500","height":"40px"}' class="item-label">班级</label>
