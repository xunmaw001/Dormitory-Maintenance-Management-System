	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="date" v-if="type!='info'" label="建筑日期" prop="jianzhuriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.jianzhuriqi" 
						type="date"
						:readonly="ro.jianzhuriqi"
						placeholder="建筑日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-else-if="ruleForm.jianzhuriqi" label="建筑日期" prop="jianzhuriqi">
					<el-input v-model="ruleForm.jianzhuriqi" placeholder="建筑日期" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' class="input" v-if="type!='info'"  label="占地面积" prop="zhandimianji">
					<el-input v-model="ruleForm.zhandimianji" placeholder="占地面积" clearable  :readonly="ro.zhandimianji"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else class="input" label="占地面积" prop="zhandimianji">
					<el-input v-model="ruleForm.zhandimianji" placeholder="占地面积" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="楼栋详情" prop="loudongxiangqing">
					<editor 
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.loudongxiangqing" label="楼栋详情" prop="loudongxiangqing">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.loudongxiangqing"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jianzhuriqi'){
							this.ruleForm.jianzhuriqi = obj[o];
							this.ro.jianzhuriqi = true;
							continue;
						}
						if(o=='zhandimianji'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.loudongxiangqing = this.ruleForm.loudongxiangqing.replace(reg,'../../../springbootsq95x/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
