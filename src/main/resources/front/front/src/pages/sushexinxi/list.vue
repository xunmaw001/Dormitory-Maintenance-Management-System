...
<div>
    ...
    <el-form :inline="true" :model="formSearch" class="list-form-pv" :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>楼号</div>
        <el-input v-model="formSearch.louhao" placeholder="楼号" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
      ...
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>宿舍位置</div>
        <el-input v-model="formSearch.susheweizhi" placeholder="宿舍位置" clearable></el-input>
      </el-form-item>
      <el-form-item :style='{"margin":"0 10px"}'>
	    <div class="lable" v-if="true" :style='{"width":"auto","padding":"0 10px","lineHeight":"42px","display":"inline-block"}'>舍长</div>
        <el-input v-model="formSearch.shezhang" placeholder="舍长" clearable></el-input>
      </el-form-item>
	  ...
	  <el-button v-if="isAuth('sushexinxi','新增')" :style='{"cursor":"pointer","border":"1px solid #db961f","padding":"0px 15px","boxShadow":"1px 1px 3px #f8a412","margin":"0px 10px 0 0","color":"#fff","outline":"none","borderRadius":"4px","background":"#f8a412","width":"auto","fontSize":"14px","lineHeight":"40px","height":"40px"}' type="primary" @click="add('/index/sushexinxiAdd')"><i v-if="true" :style='{"color":"#fff","margin":"0 10px 0 0","fontSize":"14px"}' class="el-icon-circle-plus-outline"></i>添加</el-button>
    </el-form>
  ...
  export default {
    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        let searchWhere = {};
        if (this.formSearch.louhao != '') searchWhere.louhao = '%' + this.formSearch.louhao + '%';
        if (this.formSearch.sushehao != '') searchWhere.sushehao = '%' + this.formSearch.sushehao + '%';
        if (this.formSearch.susheweizhi != '') searchWhere.susheweizhi = '%' + this.formSearch.susheweizhi + '%';
        if (this.formSearch.shezhang != '') searchWhere.shezhang = '%' + this.formSearch.shezhang + '%';
