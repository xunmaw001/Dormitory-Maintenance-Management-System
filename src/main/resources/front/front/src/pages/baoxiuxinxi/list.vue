    ...
    methods: {
      ...
      getList(page, fenlei, ref = '') {
        ...
        if (this.formSearch.zhuangtai != '') searchWhere.zhuangtai = this.formSearch.zhuangtai;
	      params['sfsh'] = '是';
        this.$http.get('baoxiuxinxi/list', {params: Object.assign(params, searchWhere)}).then(res => {
          if (res.data.code == 0) {
      ...
      toDetail(item) {
        this.$router.push({path: '/index/baoxiuxinxiDetail', query: {detailObj: JSON.stringify(item)}});
      },
    }
  }
</script>
