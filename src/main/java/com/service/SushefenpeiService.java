...
public interface SushefenpeiService extends IService<SushefenpeiEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<SushefenpeiEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<SushefenpeiEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<SushefenpeiEntity> wrapper);
